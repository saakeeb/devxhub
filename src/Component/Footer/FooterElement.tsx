...
const FooterElement = () => {
  return (
    <>
      <div className="px-8 flex flex-wrap flex-col lg:flex-row items-center lg:items-start text-center lg:text-left space-y-5 lg:space-y-0 justify-between text-lg border-[#112105] border-b py-8 overflow-hidden">
        <div>
          <FooterElement1st />
        </div>
        <div>
